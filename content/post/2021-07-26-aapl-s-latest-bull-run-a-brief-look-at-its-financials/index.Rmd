...
Regardless the current price is trading roughly at 33 times its trailing 12 months earnings, a significant increase to what it was just a few years ago. Assuming it's long term earnings power continues to materially improve, we may see a continued rally after earnings as the stock moves towards new all time highs. This is assuming the Fed and other central banks remain accommodating for the foreseeable future. Any type of changes like rate hikes would probably have some sort of negative impact on the overall market, and is something AAPL would not be immune to.

On the flip side, if earnings this quarter are a disappointment, we will likely see a swift return to the downside. How far that is is up for debate.

![1Y:1D](images/graph3.png)

On the daily, the price is quite extended from the 50 moving average. A small bearish divergence after earnings is probable and the price could find support, somewhere between the 50 and 100 MA, possibly around $140.

Either way, expectations are very high right now as we approach earnings this week. Its current value has undoubtedly already priced in surpassing earnings estimates for the quarter, and we will probably see a small but significant drop after the bell rings on Tuesday. But in order to support its current value, AAPL will need to prove the iPhone super cycle has continued alongside a strong report, as well as management showcasing a bright future ahead for upcoming fall product launches. 
